...
const CorporateSolutions = () => (
  <section id="services" className="py-10 md:py-24 lg:py-28 border-b-0 border-b-[#eae8e6] border-t-0 border-r-0 border-l-0 pt-[72px] pb-[72px] md:pt-[112px] md:pb-[112px] bg-transparent">
