...
const CorporateSolutions = () => (
  <section id="services" className="py-14 md:py-24 lg:py-32 bg-philosophy">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 max-w-6xl mx-auto">
        {solutions.map((item, i) => (
          <motion.div
            ...
            className="p-5 md:p-8 rounded-xl bg-card border border-border hover:shadow-lg hover:border-gold/30 transition-all duration-300 flex flex-col"
          >
            ...
            <p className="text-muted-foreground leading-relaxed text-xs md:text-sm mb-4 md:mb-5 flex-1">{item.description}</p>
            <a href="#contact" className="inline-flex items-center gap-1 text-xs md:text-sm font-semibold text-gold hover:text-gold-light transition-colors mt-auto">
