...
const CorporateSolutions = () => (
  <section id="services" className="py-20 md:py-28 lg:py-36 bg-background border-b border-border/50 section-shadow">
    <div className="container mx-auto px-4 md:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
        {solutions.map((item, i) => (
          <div
            key={item.title}
            className="group p-5 md:p-6 lg:p-8 rounded-xl bg-card card-elevated card-elevated-hover transition-all duration-300 flex flex-col"
          >
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
