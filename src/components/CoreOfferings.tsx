      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {offerings.map((item, i) => (
          ...
          >
            ...
            >
              <div
                className="w-11 h-11 md:w-12 md:h-12 rounded-2xl flex items-center justify-center mx-auto mb-5 md:mb-6 transition-transform duration-200 group-hover:scale-[1.03] icon-tile-grain icon-tile-standard"
              >
                <item.icon
