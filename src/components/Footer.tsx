    ...
    <div className="container mx-auto px-4 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-14">
        ...
        <div className="lg:col-span-2">
          <h3 className="font-heading text-2xl font-bold mb-4">LEUNRE</h3>
          <p className="text-primary-foreground/65 text-sm leading-relaxed mb-6 max-w-xs">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-4 py-3 bg-gold text-accent-foreground rounded-md text-sm font-semibold hover:brightness-110 transition-all whitespace-nowrap">
              Subscribe
            </button>
          </div>
        </div>
