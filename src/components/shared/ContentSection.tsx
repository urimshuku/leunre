...
const paddingMap = {
  default: "py-16 md:py-24 lg:py-28 pt-[112px] pb-[112px] border-b-0 border-x-0 border-t-0 border-b-[#eae8e6]",
  warm: "py-16 md:py-24 lg:py-28 pt-[112px] pb-[112px] border-b-0 border-x-0 border-t-0 border-b-[#eae8e6]",
