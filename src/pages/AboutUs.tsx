    ...
    <main>
      ...
      <section className="py-14 md:py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
          ...
          >
            <div className="gold-divider mb-4 md:mb-6" />
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-foreground mb-6 md:mb-8">
              Our Story
            </h2>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
            {philosophySteps.map((step, i) => (
              ...
              >
                <div className="w-12 h-12 md:w-16 md:h-16 mx-auto rounded-2xl bg-card border border-border flex items-center justify-center mb-4 md:mb-6">
                  <step.icon className="w-5 h-5 md:w-7 md:h-7 text-primary" />
                </div>
                <h3 className="text-lg md:text-xl font-heading font-bold text-foreground mb-2 md:mb-3">{step.label}</h3>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 max-w-4xl mx-auto">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-card rounded-xl border border-border p-6 md:p-10"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
            {values.map((value, i) => (
              ...
              >
                ...
                <h3 className="text-base md:text-lg font-heading font-bold text-foreground mb-1.5 md:mb-2">{value.title}</h3>
      ...
      <section className="py-14 md:py-24 bg-hero-gradient">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-primary-foreground/70 text-sm md:text-lg leading-relaxed mb-4 md:mb-6">
            ...
            <p className="text-primary-foreground/70 text-sm md:text-lg leading-relaxed mb-8 md:mb-10">
