const colors = [
  ...
  { name: "Warm / Cream", token: "--warm", hsl: "30 32% 93%", hex: "#F1F1EF", usage: "Section alt backgrounds" },
  { name: "Philosophy BG", token: "--philosophy-bg", hsl: "30 32% 93%", hex: "#F1F1EF", usage: "Philosophy, Corporate, CTA sections" },
  ...
  { name: "Separator", token: "separator", hsl: "30 10% 81%", hex: "#D8CEC5", usage: "Dividers, separators" },
  ...
  <div className="min-h-screen bg-white p-8 md:p-12 lg:p-16 max-w-4xl mx-auto print:p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {colors.map((c) => (
          <div key={c.token} className="border rounded-lg overflow-hidden" style={{ borderColor: "#E7E1DB" }}>
            ...
            <div className="p-3">
              <p className="font-heading font-normal text-sm" style={{ color: "#5C3A2E" }}>{c.name}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {typography.map((t) => (
          <div key={t.name} className="border rounded-lg p-5" style={{ borderColor: "#E7E1DB" }}>
            <p className="text-3xl font-heading font-normal mb-2" style={{ color: "#5C3A2E", fontFamily: t.family }}>Aa</p>
            <p className="font-heading font-normal text-sm" style={{ color: "#5C3A2E" }}>{t.family}</p>
    ...
    <section className="mb-12">
      ...
      <div className="border rounded-lg p-5 space-y-2" style={{ borderColor: "#E7E1DB" }}>
        ...
        <p className="text-sm" style={{ color: "#5C3A2E" }}>• Separator color: #D8CEC5 (warm neutral).</p>
        <p className="text-sm" style={{ color: "#5C3A2E" }}>• Global line-height: ~1.6 for calmness and legibility.</p>
        <p className="text-sm" style={{ color: "#5C3A2E" }}>• Letter spacing on headings: -0.005em for editorial refinement.</p>
      </div>
    </section>
